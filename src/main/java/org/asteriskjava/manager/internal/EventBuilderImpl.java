...
class EventBuilderImpl extends AbstractBuilder implements EventBuilder
{
    ...
    private void registerBuiltinEventClasses()
    {
        ...
        registerEventClass(ContactStatusDetailEvent.class);
        ...
        registerEventClass(EndpointDetailEvent.class);
        registerEventClass(EndpointListEvent.class);
        registerEventClass(EndpointListCompleteEvent.class);
